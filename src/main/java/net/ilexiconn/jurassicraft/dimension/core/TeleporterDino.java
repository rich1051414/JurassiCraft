...
public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
{
         ...
         else
         {
                 for (k1 = l - short1; k1 <= l + short1; ++k1)
                 {
                         ...
                         for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                         {
                                 ...
                                 {
                                         /** change this block **/
                                         if (this.worldServerInstance.getBlock(k1, i2, l1) == ModBlocks.DinoPortal)
                                         {
                                                 /** change this block **/
                                                 while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == ModBlocks.DinoPortal)
                                                 {
                                                         --i2;
                                                 }
         ...
         if (d3 >= 0.0D)
         {
                 ...
                 int j2 = -1;
                 /** change this block **/
                 if (this.worldServerInstance.getBlock(i - 1, j, k) == ModBlocks.DinoPortal)
                 {
                         j2 = 2;
                 }
                 /** change this block **/
                 ...
                 /** change this block **/
                 if (this.worldServerInstance.getBlock(i, j, k - 1) == ModBlocks.DinoPortal)
                 {
                         j2 = 3;
                 }
                 /** change this block **/
