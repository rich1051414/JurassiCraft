...
this.myBiomesToSpawnIn.add(ModBiomes.DinoIslands);
this.myBiomesToSpawnIn.add(ModBiomes.DinoPlains);
...
par1ArrayOfBiomeGenBase[i] = ModBiomes.DinoJungle;
}
}
