...
import net.ilexiconn.jurassicraft.recipe.GrinderManager;
import net.ilexiconn.jurassicraft.utility.helper.ItemStackHelper;
...
public class TileEntityGrinder extends TileEntity implements ISidedInventory
{
    ...
    {
        if (this.contents[this.slotGrindingItemIndex] == null)
            return false;
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning() && this.canGrind() && this.hasGrindingStone())
            {
                ...
                {
                    JurassiCraft.NETWORK_MANAGER.sendPacketToAllAround(new PacketGrindSound(this.xCoord, this.yCoord, this.zCoord), this.worldObj.provider.dimensionId, this.xCoord, this.yCoord, this.zCoord, 30D);
                }
    ...
    private boolean canGrind()
    {
        ...
        if (itemstack == null)
            return false;
        if (this.contents[slotOutput1Index] == null || this.contents[slotOutput2Index] == null)
            return true;
