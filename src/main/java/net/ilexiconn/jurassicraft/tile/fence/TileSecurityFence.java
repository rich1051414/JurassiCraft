            ...
            case 0:
                switch (securityLevel)
                {
                    ...
                    case 1:
                        ...
                        for (int k = 1; k < distance - 1; k++)
                        {
                            if (!this.worldObj.isAirBlock(this.xCoord, this.yCoord + 3, this.zCoord + k)) return false;
                        }
                        return true;
                    case 2:
                        if (!this.hasSecurityFenceMainBlockAt(this.worldObj, this.xCoord, this.yCoord, this.zCoord))
            ...
            case 1:
                switch (securityLevel)
                {
                    ...
                    case 1:
                        ...
                        for (int i = 1; i < distance - 1; i++)
                        {
                            if (!this.worldObj.isAirBlock(this.xCoord - i, this.yCoord + 3, this.zCoord)) return false;
                        }
                        return true;
                    case 2:
                        if (!this.hasSecurityFenceMainBlockAt(this.worldObj, this.xCoord, this.yCoord, this.zCoord))
