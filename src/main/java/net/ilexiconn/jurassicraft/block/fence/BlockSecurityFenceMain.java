...
public class BlockSecurityFenceMain extends BlockContainer
{
    public BlockSecurityFenceMain()
    {
        ...
        this.setBlockTextureName(JurassiCraft.getModId() + "security_Fence_Main");
        ...
        if (tileEntity instanceof TileSecurityFence)
        {
            ...
            for (int direction = 0; direction < 4; direction++)
            {
                if (tileFence.isFenceBuilt(direction))
                {
                    ...
                    {
                        case 0:
                            if (nextFence instanceof TileSecurityFence) nextFence.setSecurityLevel((byte) 0, 2);
                            ...
                            break;
                        case 1:
                            if (nextFence instanceof TileSecurityFence) nextFence.setSecurityLevel((byte) 0, 3);
                            for (int distance = 0; distance < fenceLength; distance++)
                            {
                            ...
                            break;
                        case 2:
                            if (nextFence instanceof TileSecurityFence) nextFence.setSecurityLevel((byte) 0, 0);
                            for (int distance = 0; distance < fenceLength; distance++)
                            {
                                if (world.getBlock(x, y, z - distance) instanceof IFenceBase)
                                {
                            ...
                            break;
                        case 3:
                            if (nextFence instanceof TileSecurityFence) nextFence.setSecurityLevel((byte) 0, 1);
                            for (int distance = 0; distance < fenceLength; distance++)
                            {
                                if (world.getBlock(x + distance, y, z) instanceof IFenceBase)
                                {
