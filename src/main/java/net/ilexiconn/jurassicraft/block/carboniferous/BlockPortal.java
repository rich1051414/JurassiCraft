...
public class BlockPortal extends BlockBreakable
{
    ...
    public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity)
    {
        if (entity.ridingEntity == null && entity.riddenByEntity == null)
        {
            if (entity instanceof EntityPlayerMP)
            {
                ...
                {
                    thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Properties.dimensionID, new TeleporterDino(thePlayer.mcServer.worldServerForDimension(Properties.dimensionID)));
                }
            }
        }
    }
    ...
    public void travelToDimension(World worldObj, Entity entity, int par1)
    {
        if (!worldObj.isRemote && !entity.isDead)
        {
            ...
            minecraftserver.getConfigurationManager().transferEntityToWorld(entity, j, worldserver, worldserver1, new TeleporterDino(worldserver1));
