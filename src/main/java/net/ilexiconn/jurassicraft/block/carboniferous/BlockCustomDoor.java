...
public class BlockCustomDoor extends Block
{
    ...
    private static final String[] doorBottomIconNames = new String[] { "doorLepido_lower", "doorLepido_upper", "doorCalamites_lower", "doorCalamites_upper", "doorCordaites_lower", "doorCordaites_upper", "doorSigilaria_lower", "doorSigilaria_upper", "amphibianDoor_lower", "amphibianDoor_upper" };
    ...
    public Item getItemDropped(int par1, Random par2Random, int par3)
    {
        if ((par1 & 8) != 0)
            return null;
        return net.ilexiconn.jurassicraft.ModItems.multiItems;
    }
