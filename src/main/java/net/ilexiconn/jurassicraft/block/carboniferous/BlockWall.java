...
public class BlockWall extends net.minecraft.block.BlockWall
{
    ...
    public IIcon getIcon(int side, int meta)
    {
        ...
        {
            case 0:
                return ModBlocks.multiBlock1.getIcon(side, 0);
            case 1:
                return ModBlocks.multiBlock1.getIcon(side, 1);
            case 2:
                return ModBlocks.multiBlock1.getIcon(side, 2);
            case 3:
                return ModBlocks.multiBlock1.getIcon(side, 3);
            case 4:
                return ModBlocks.multiBlock1.getIcon(side, 4);
            case 5:
                return ModBlocks.dirt.getIcon(side, 0);
            default:
                return null;
        }
    }
