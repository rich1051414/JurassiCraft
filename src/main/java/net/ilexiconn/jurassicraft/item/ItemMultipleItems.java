...
public class ItemMultipleItems extends Item
{
    ...
    public IIcon getIconFromDamage(int par1)
    {
        ...
        {
            case 0:
                return this.doorLepidodendron;
            case 1:
                return this.iconIronClump;
            case 2:
                return this.iconIronOreClumps;
            case 3:
                return this.iconPyriteCrystal;
            case 4:
                return this.iconHematite;
            case 5:
                return this.iconTimerod;
            case 6:
                return this.iconShellAmmonite;
            case 7:
                return this.iconShellBrachiopod;
            case 8:
                return this.iconPearl;
            case 9:
                return this.graniteGear;
            case 10:
                return this.amphibianSkin;
            case 11:
                return this.sharkTooth;
            case 12:
                return this.dragonflyWings;
            case 13:
                return this.carbonDust;
            case 14:
                return this.doorCalamites;
            case 15:
                return this.doorCordaites;
            case 16:
                return this.doorSigillaria;
            case 17:
                return this.doorAmphibian;
        }
        return null;
    }
