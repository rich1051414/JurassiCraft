...
public class ItemMammalSyringe extends Item {
	...
	if (syringe.hasTagCompound() && syringe.getTagCompound().hasKey("SyringeQuality") && syringe.getTagCompound().getInteger("SyringeQuality") >= 50) {
		...
		if (!this.creaturesFromCow.contains(this.mammalName.toLowerCase())) {
		    return false;
		} else {
		...
		if (!this.creaturesFromPig.contains(this.mammalName.toLowerCase())) {
		    return false;
		} else {
		...
		if (!this.creaturesFromHorse.contains(this.mammalName.toLowerCase())) {
		    return false;
		} else {
		...
		if (!this.creaturesFromSheep.contains(this.mammalName.toLowerCase())) {
		    return false;
		} else {
