...
public class BlockFossilClayOre extends Block implements ISubBlocksBlock
{
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        for (int i = 0; i < this.icon_0.length; ++i)
        {
            if (!(colors[i].equals("")))
            {
                this.icon_0[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_0_hardened_clay_stained_" + colors[i]);
                this.icon_1[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_1_hardened_clay_stained_" + colors[i]);
                this.icon_2[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_2_hardened_clay_stained_" + colors[i]);
                this.icon_3[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_3_hardened_clay_stained_" + colors[i]);
                this.icon_4[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_4_hardened_clay_stained_" + colors[i]);
                this.icon_5[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_5_hardened_clay_stained_" + colors[i]);
            }
            else
            {
                this.icon_0[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_0_hardened_clay");
                this.icon_1[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_1_hardened_clay");
                this.icon_2[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_2_hardened_clay");
                this.icon_3[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_3_hardened_clay");
                this.icon_4[i] = register.registerIcon(JurassiCraft.getModId() + "fossil/fossil_side_4_hardened_clay");
