...
public class JCRecipeRegistry implements IContentHandler
{
    public void init()
    {
        ...
        for (Creature creature : CreatureHandler.getCreatures())
        {
            ...
            if (meat != null)
            {
                GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(meat, 1));
            }
        }
        ...
        GameRegistry.addShapedRecipe(new ItemStack(JCItemRegistry.gypsumPowder, 2), "TG", 'T', Items.stone_pickaxe.setContainerItem(Items.stone_pickaxe), 'G', JCBlockRegistry.gypsumCobblestone);
        GameRegistry.addShapedRecipe(new ItemStack(JCItemRegistry.gypsumPowder, 2), "TG", 'T', Items.iron_pickaxe.setContainerItem(Items.iron_pickaxe), 'G', JCBlockRegistry.gypsumCobblestone);
        GameRegistry.addShapedRecipe(new ItemStack(JCItemRegistry.gypsumPowder, 2), "TG", 'T', Items.diamond_pickaxe.setContainerItem(Items.diamond_pickaxe), 'G', JCBlockRegistry.gypsumCobblestone);
        GameRegistry.addShapedRecipe(new ItemStack(JCBlockRegistry.gypsumBrick, 1), "BB", "BB", 'B', JCBlockRegistry.gypsumBlock);

        GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(Items.beef, 1));
        GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(Items.fish, 1));
        GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(Items.porkchop, 1));
        GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(Items.chicken, 1));
        GameRegistry.addShapelessRecipe(new ItemStack(JCItemRegistry.growthSerum, 1), new ItemStack(Items.dye, 1, 2), new ItemStack(Items.golden_carrot, 1), new ItemStack(Items.water_bucket, 1), new ItemStack(Items.cooked_beef, 1));
