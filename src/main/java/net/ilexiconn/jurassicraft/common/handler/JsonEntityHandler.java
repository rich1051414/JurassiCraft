...
public class JsonEntityHandler
{
    ...
    public void parseServerEntities()
    {
        ...
        for (CreatureContainer dino : dinos) CreatureHandler.addCreature(dino, "dinosaurs");
        for (CreatureContainer creature : reptiles) CreatureHandler.addCreature(creature, "reptiles");
        for (CreatureContainer creature : mammals) CreatureHandler.addCreature(creature, "mammals");
        for (CreatureContainer creature : birds) CreatureHandler.addCreature(creature, "birds");
        for (CreatureContainer creature : fish) CreatureHandler.addCreature(creature, "fish");
        for (CreatureContainer creature : cephalopods) CreatureHandler.addCreature(creature, "cephalopods");
        for (CreatureContainer creature : arthropods) CreatureHandler.addCreature(creature, "arthropods");
    }
    ...
    public void parseClientEntities() throws Exception
    {
        ...
        for (CreatureContainer creature : dinos) CreatureHandler.addCreatureRenderer(creature, "dinosaurs");
        for (CreatureContainer creature : reptiles) CreatureHandler.addCreatureRenderer(creature, "reptiles");
        for (CreatureContainer creature : mammals) CreatureHandler.addCreatureRenderer(creature, "mammals");
        for (CreatureContainer creature : birds) CreatureHandler.addCreatureRenderer(creature, "birds");
        for (CreatureContainer creature : fish) CreatureHandler.addCreatureRenderer(creature, "fish");
        for (CreatureContainer creature : cephalopods) CreatureHandler.addCreatureRenderer(creature, "cephalopods");
        for (CreatureContainer creature : arthropods) CreatureHandler.addCreatureRenderer(creature, "arthropods");
    }
