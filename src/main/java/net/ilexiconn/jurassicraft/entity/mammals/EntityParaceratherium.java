...
public class EntityParaceratherium extends EntityJurassiCraftLandProtective implements IMammal
{
    ...
    {
        super(world, CreatureManager.classToCreature(EntityParaceratherium.class), 1);
    ...
    protected void dropFewItems(boolean recentlyBeenHit, int enchantBonus)
    {
        ...
        int count = Math.round(1 + (5.5F * developmentFraction) + this.rand.nextInt(0 + (int) (5.0F * developmentFraction)) + this.rand.nextInt(enchantBonus));
    	if (!this.isBurning())
        {
