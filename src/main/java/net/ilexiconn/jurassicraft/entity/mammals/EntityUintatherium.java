...
public class EntityUintatherium extends EntityJurassiCraftLandProtective implements IMammal
{
    ...
    {
        super(world, CreatureManager.classToCreature(EntityUintatherium.class), 1);
    ...
    protected void dropFewItems(boolean recentlyBeenHit, int enchantBonus)
    {
        ...
        int count = Math.round(1 + (4.0F * developmentFraction) + this.rand.nextInt(0 + (int) (4.5F * developmentFraction)) + this.rand.nextInt(enchantBonus));
    	if (!this.isBurning())
        {
