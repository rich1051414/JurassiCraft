...
import net.ilexiconn.jurassicraft.ai.test.JurassiCraftAIAvoidEntityIfNotTamed;
...
public class EntityHypsilophodon extends EntityJurassiCraftSmart implements IDinosaur, IHerbivore
{
