...
public class EntityCearadactylusFlyable extends EntityJurassiCraftRidableFlying implements IReptile, IPiscivore
{

    public EntityCearadactylusFlyable(World world)
    {
        super(world, CreatureManager.classToCreature(EntityCearadactylusFlyable.class));
