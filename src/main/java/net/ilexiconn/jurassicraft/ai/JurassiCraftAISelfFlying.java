...
public class JurassiCraftAISelfFlying extends EntityAIBase
{
    ...
    {
        if (this.creature.getRNG().nextInt(this.flyingChance) == 0) if (this.creature.riddenByEntity == null)
    ...
    {
        if (this.creature.getRNG().nextBoolean()) this.height = this.getHeight();

        if (this.height < 6) this.goUp();
