...
public class JCPathNavigate extends PathNavigate
{
     ...
     * @return
     *        The list of validators used by this Navigator
     ...
     * @param validator
     *                 The validator to add to the validators used to check pathes
     * @see {@link IPathValidator}
     */
     ...
     *            The path to follow
     * @param speed
     *             The speed at which the path will be executed
     * @return
     *        A boolean equal to <code>true</code> if the path is considered valid by all validators.
     *        
