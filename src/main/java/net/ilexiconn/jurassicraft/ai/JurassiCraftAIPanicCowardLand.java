...
public class JurassiCraftAIPanicCowardLand extends EntityAIBase
{
    ...
    public JurassiCraftAIPanicCowardLand(EntityJurassiCraftLandCoward creature, double newSpeed)
    {
