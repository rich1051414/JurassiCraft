...
public class JurassiCraftAIPlayfulBaby extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        if (this.otherCreature.isTakingOff()) this.otherCreature.setTakingOff(false);
        if (this.otherCreature.isFlying()) this.otherCreature.setFlying(false);
        if (this.otherCreature.isDefending()) this.otherCreature.setDefending(false);
        if (this.otherCreature.isAttacking()) this.otherCreature.setAttacking(false);
        if (this.otherCreature.isFleeing()) this.otherCreature.setFleeing(false);
        if (this.otherCreature.isEating()) this.otherCreature.setEating(false);
