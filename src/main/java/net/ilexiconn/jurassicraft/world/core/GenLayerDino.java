...
public class GenLayerDino
{
    public static GenLayer[] createDim(long var0, WorldType var2) {
        ...
        GenLayerBiomesDino var4 = new GenLayerBiomesDino(200L);
        ...
        GenLayerBiomesDino var14 = new GenLayerBiomesDino(200L, var6);
        var6 = GenLayerZoom.magnify(1000L, var14, 2);
        Object var12 = new GenLayerHills(1000L, var6, var4);
