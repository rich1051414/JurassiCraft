...
public class ModelOrthacanthus extends MowzieModelBase 
{
	...
	public ModelOrthacanthus() 
	{
		...
		this.hornTop.setInitValuesToCurrentPose();
		this.fliperLeft1.setInitValuesToCurrentPose();
		this.fliperRight1.setInitValuesToCurrentPose();
		this.finFront1.setInitValuesToCurrentPose();
		this.body2.setInitValuesToCurrentPose();
		this.fliperLeft2.setInitValuesToCurrentPose();
		this.fliperRight2.setInitValuesToCurrentPose();
		this.finFront2.setInitValuesToCurrentPose();
		this.body3.setInitValuesToCurrentPose();
		this.fliperLeft3.setInitValuesToCurrentPose();
		this.fliperRight3.setInitValuesToCurrentPose();
		this.finFront3.setInitValuesToCurrentPose();
		this.body4.setInitValuesToCurrentPose();
		this.fliperLeft4.setInitValuesToCurrentPose();
		this.fliperRight4.setInitValuesToCurrentPose();
	...
	public void resetPose() 
	{
		...
		this.hornTop.setCurrentPoseToInitValues();
		this.fliperLeft1.setCurrentPoseToInitValues();
		this.fliperRight1.setCurrentPoseToInitValues();
		this.finFront1.setCurrentPoseToInitValues();
		this.body2.setCurrentPoseToInitValues();
		this.fliperLeft2.setCurrentPoseToInitValues();
		this.fliperRight2.setCurrentPoseToInitValues();
		this.finFront2.setCurrentPoseToInitValues();
		this.body3.setCurrentPoseToInitValues();
		this.fliperLeft3.setCurrentPoseToInitValues();
		this.fliperRight3.setCurrentPoseToInitValues();
		this.finFront3.setCurrentPoseToInitValues();
		this.body4.setCurrentPoseToInitValues();
		this.fliperLeft4.setCurrentPoseToInitValues();
		this.fliperRight4.setCurrentPoseToInitValues();
		this.body5.setCurrentPoseToInitValues();
		this.finBack.setCurrentPoseToInitValues();
	}
}
